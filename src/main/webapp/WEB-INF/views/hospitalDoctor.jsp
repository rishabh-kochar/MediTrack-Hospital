							...
							<tbody>
								...
								<c:forEach items="${doctors}" var="doctor">
									<tr>
										...
										<td><a href="/hospital/adddoctor?id=${doctor.doctorID }"><button
													type="button" name="btnview" value="View Event"
													class="btn btn-info"
													style="border-radius: 10px; margin-top: 1px;">Update</button></a>
											<%-- <c:if test="${doctor.status == 1 }">
												<a href="/hospital/deactivedoctor?id=${doctor.doctorID }"><button type="button" name="btnapprove"
														value="Dispatch Event" class="btn btn-success"
														style="border-radius: 10px; margin-top: 1px;">Approve</button></a>
											</c:if> <c:if test="${doctor.status == 0 }">
												<a href="/hospital/activedoctor?id=${doctor.doctorID }"><button type="button" name="btnapprove"
